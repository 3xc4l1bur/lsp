            ...
            <div class="container">
                ...
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="img/gopud.png" alt="sing up image"></figure>
                    </div>
                    <div class="signin-form">
                        <h2 class="form-title" style="font-size:25px;" >Sign In</h2>
                        <form method="POST" class="register-form" id="login-form" action="{{route('user.signin')}}">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{url('/regis')}}" for="new-account" name="new-account" id="new-account" style="margin-left: 30px; margin-right:-60px;">Don't have account?</a>
                            </div>
